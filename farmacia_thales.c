...
void recebe_inf(){                          /*function para receber as infos de um produto novo e armazenar em um arquivo binario*/
    ...
    for(i=0; i<1; i++){              /*la�o for que pede as infos de um novo produto para cadastro*/
...
void busca_prod(){                       /*function de busca por produto j� cadastrado no arquivo*/
    ...
    for(i=0; i<max; i++){           /*la�o for para alterar a quantidadde do produto j� cadastrado*/
        ...
        if(j == 0){                 /*la�o de resposta para caso o produto n�o seja encontrado (n�o cadastrado ainda)*/
...
void altera_prod(){                 /*function para fazer qualquer altera��o num dado produto j� cadastrado*/
    int i, codigo;
    ...
    for(i=0; i<max; i++){                        /*entrada dos novos dados do produto j� computado*/
...
void painel(){                          /*function do 'menu' do programa*/
    ...
    if(stricmp(verificador, "nao")==0){           /*limpa a tela conforme a vontade do usu�rio*/
        recebe_inf();
    ...
    else{                             /*exibe as op��es do usuario e espera por uma resposta, reagindo a qualquer entrada possivel*/
        for(k=1;k<max;k++){
